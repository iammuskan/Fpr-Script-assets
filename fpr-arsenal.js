...
const FPRArsenalIQ = (() => {
  ...
  function renderWelcome() {
    return `<div class="fpr-iq-welcome">
      <div class="fpr-iq-welcome-icon"><i class="ti ti-shield-check" style="color:#1b2f4e;"></i></div>
      ...
      <p class="fpr-iq-welcome-sub">
        Your readiness score evolves as your life, family, and responsibilities change.
      </p>
